...
public class RegisterActivity extends AppCompatActivity {
  ...
  protected void onCreate(@Nullable Bundle savedInstanceState) {
    ...
    travelNo.setOnClickListener(
        v -> {
          travelYes.setChecked(false);
          travelStatus = 2;
        });
    travelYes.setOnClickListener(
        v -> {
  ...
  private void OpenDialog() {
    ...
    if (map != null) {
      ...
      if (qStatus) qYes.setChecked(true);
      else qNo.setChecked(true);
    ...
    qYes.setOnClickListener(
        v -> {
          qNo.setChecked(false);
          qStatus = true;
        });
    qNo.setOnClickListener(
        v -> {
          qYes.setChecked(false);
          qStatus = false;
        });
    typeGovt.setOnClickListener(
        v -> {
          typeHome.setChecked(false);
          quartype = "Govt. Center";
        });
    typeHome.setOnClickListener(
        v -> {
