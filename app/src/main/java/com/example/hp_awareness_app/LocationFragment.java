...
public class LocationFragment extends Fragment {
    ...
    if (ContextCompat.checkSelfPermission(getContext(), Manifest.permission.ACCESS_FINE_LOCATION)
      ...
      if (ActivityCompat.shouldShowRequestPermissionRationale(
        ...
        ActivityCompat.requestPermissions(
            getActivity(), new String[] {Manifest.permission.ACCESS_FINE_LOCATION}, reqCode);
      } else {
        ActivityCompat.requestPermissions(
            getActivity(), new String[] {Manifest.permission.ACCESS_FINE_LOCATION}, reqCode);
      }
    ...
    locationTask.addOnSuccessListener(
        new OnSuccessListener<Location>() {
          ...
          public void onSuccess(Location location) {
            ...
            } else Log.e("Null", "location was null...");
          }
        });
  ...
  private void checkSettingsAndStartLocationUpdates() {
    ...
    locationSettingsRequestTask.addOnSuccessListener(
    ...
    locationSettingsRequestTask.addOnFailureListener(
        new OnFailureListener() {
          @Override
          public void onFailure(@NonNull Exception e) {
