        ...
        new Callback<ModelCovidCase>() {
          ...
          public void onResponse(Call<ModelCovidCase> call, Response<ModelCovidCase> response) {
            if (response.isSuccessful()) {
              ...
              BilaspurAdapter adapter =
                  new BilaspurAdapter(districtCases, CovidUpdatesActivity.this);
              recyclerView.setLayoutManager(new LinearLayoutManager(CovidUpdatesActivity.this));
